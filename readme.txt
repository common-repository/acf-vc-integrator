...
Advanced Custom Fields right inside your WPBakery Page Builder

The ACF-VC Plugin puts a ACF element into your WPBakery Page Builder, making it easier than ever to use your custom created fields in your own page design.
...
Bug fix: When using target _blank on the file field, resulted in fatal error.

= 1.8.4 =
Release Date: December 20, 2022

* New stuff: Added option to use Custom Link Text for the URL field.
* Change: Modified filter hook for acfvc_url to include the link text 

= 1.8.3 =
Release Date: January 22, 2022

* Bug fix: gallery field url option error.
* Change: Modified image field output to use wp_get_attachment_image.
* New stuff: Added option to select image size for the image field: https://wordpress.org/support/topic/images-sizes-in-file-field/
* Clean up some of the code.

= 1.8.2 =
Release Date: June 6, 2020

* Bug fix: taxonomy field could only use standard category field. This is now fixed so that it can use all taxonomy.
* Change: Removed Support for acf versions under version 5 for image and file field.
* New stuff: You can now use the oEmbed field to view audio and video from the media library.
* New stuff: It is now possible with the file field to choose video/audio to be displayed with video or audio html tag
